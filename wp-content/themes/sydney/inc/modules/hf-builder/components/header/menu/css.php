...
// Text Color Hover
$css .= Sydney_Custom_CSS::get_color_css( 'shfb_main_header_color_hover', '', '.shfb .main-navigation a.sydney-dropdown-link:hover, .shfb .main-navigation li.sydney-dropdown-li:hover > a.sydney-dropdown-link' );
$css .= Sydney_Custom_CSS::get_fill_css( 'shfb_main_header_color_hover', '', '.shfb .main-navigation a.sydney-dropdown-link:hover + .dropdown-symbol svg, .shfb .main-navigation li.sydney-dropdown-li:hover > .dropdown-symbol svg' );
...
$css .= Sydney_Custom_CSS::get_color_css( 'shfb_main_header_submenu_color_hover', '', '.shfb .main-navigation .sub-menu.sydney-dropdown-ul a.sydney-dropdown-link:hover, .shfb .main-navigation .sub-menu.sydney-dropdown-ul li.sydney-dropdown-li:hover > a.sydney-dropdown-link' );
$css .= Sydney_Custom_CSS::get_fill_css( 'shfb_main_header_submenu_color_hover', '', '.shfb .main-navigation .sub-menu.sydney-dropdown-ul a.sydney-dropdown-link:hover + .dropdown-symbol svg, .shfb .main-navigation .sub-menu.sydney-dropdown-ul li.sydney-dropdown-li:hover > .dropdown-symbol svg' );
...
$css .= Sydney_Custom_CSS::get_color_css( 'shfb_main_header_sticky_active_color_hover', '', '.sticky-header-active .shfb .main-navigation a.sydney-dropdown-link:hover, .sticky-header-active .shfb .main-navigation li.sydney-dropdown-li:hover > a.sydney-dropdown-link' );
$css .= Sydney_Custom_CSS::get_fill_css( 'shfb_main_header_sticky_active_color_hover', '', '.sticky-header-active .shfb .main-navigation a.sydney-dropdown-link:hover + .dropdown-symbol svg, .sticky-header-active .shfb .main-navigation li.sydney-dropdown-li:hover > .dropdown-symbol svg' );
...
$css .= Sydney_Custom_CSS::get_color_css( 'shfb_main_header_sticky_active_submenu_color_hover', '', '.sticky-header-active .shfb .main-navigation .sub-menu.sydney-dropdown-ul a.sydney-dropdown-link:hover, .sticky-header-active .shfb .main-navigation .sub-menu.sydney-dropdown-ul li.sydney-dropdown-li:hover > a.sydney-dropdown-link' );
$css .= Sydney_Custom_CSS::get_fill_css( 'shfb_main_header_sticky_active_submenu_color_hover', '', '.sticky-header-active .shfb .main-navigation .sub-menu.sydney-dropdown-ul a.sydney-dropdown-link:hover + .dropdown-symbol svg, .sticky-header-active .shfb .main-navigation .sub-menu.sydney-dropdown-ul li.sydney-dropdown-li:hover > .dropdown-symbol svg' );
